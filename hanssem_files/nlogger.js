...
Nethru.Settings = function() {
    ...
    // 로깅서버 URL
    var NTH_LOGGING_URL_BASE_HTTP = "https://mallbilog.hanssem.com:1443/nlog";
    var NTH_LOGGING_URL_BASE_HTTPS = "https://mallbilog.hanssem.com:1443/nlog";

    // 단말 ID
    var NTH_PCID = "nth_pcid";
    var NTH_PCID_KEY = "PCID";
    var NTH_PCID_DOMAIN = "hanssem.com";
    var NTH_ALWAYS_HAS_PCID = false;

    // 회원 ID
    var NTH_UID = "nth_uid";
    var NTH_UID_KEY = "loginCookieId";
